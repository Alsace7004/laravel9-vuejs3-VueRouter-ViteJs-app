...
<html lang="en">
  ...
  <body class="" style="border:1px solid red;width:100vw;font-size:10px">
    ...
    <div class="invoice p-5 mb-3" style="border:1px solid green;">
      ...
      <div class="row">
        <div class="col-12">
            <div class="container_1">
                <div class="class-1">
                    <i class="fas fa-globe"></i><small style="display: block;"><strong>Moyenne du Trimestre 1 :</strong>18.47</small> 
                    <i class="fas fa-globe"></i><small style="display: block;"><strong>Année Scolaire :</strong>  2022-2023</small>
                </div>
                <div class="class-2">
                    <small style="display: block;" ><strong>Classement</strong>1 er</small> 
                    <small style="display: block;" ><strong>Effectif :</strong>  5</small>
                </div>
            </div>
        </div>
